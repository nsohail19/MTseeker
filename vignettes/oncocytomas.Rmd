...
*NOTE* This will fail if you try using the bams from the oncocytomaBams git repository!
...
if (FALSE) { 
  ...
  RONKSvariants <- callMT(RONKSreads, parallel = TRUE,
...
RONKSvariants <- haploMask(RONKSvariants)

# if you are running this on a linux machine with openJDK installed as the default
# it will fail
# unfortunately, you need oracle java to have haplogrep run...
# RONKSvariants <- haploMask(RONKSvariants, java.path = "/user/bin/java")
